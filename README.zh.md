...
**现在能下载桌面安装器吗？** 可以。[Plus 0.2.0](https://github.com/SparkElf/deepseek-harness-plus/releases/tag/plus-v0.2.0) 提供 Linux AppImage/deb 和 Windows NSIS 安装器。macOS 延后到配置好签名和 notarization 后再恢复。
