...
target是exact official source revision `5dda764ed3aa172535a7967b06ff95d9cbfe536a`。payload只修改API Gateway journal stream及其既有Client test；responsive layout、Sidebar、Composer与Mobile Bridge transport仍由当前owner持有。
