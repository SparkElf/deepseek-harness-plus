...
target是exact official source revision `b2e3b2a0125854567a4a5fcba75782e42fe84901`。payload只修改API Gateway journal stream及其既有Client test；responsive layout、Sidebar、Composer与Mobile Bridge transport仍由当前owner持有。
