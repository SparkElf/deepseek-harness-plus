...
The target is exact official source revision `b2e3b2a0125854567a4a5fcba75782e42fe84901`. The payload changes the API Gateway journal stream and its existing Client test only; responsive layout, Sidebar, Composer, and Mobile Bridge transport remain in their current owners.
