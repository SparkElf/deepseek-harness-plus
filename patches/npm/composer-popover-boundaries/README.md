...
The target is exact official source revision `5dda764ed3aa172535a7967b06ff95d9cbfe536a`. The payload contains only the focused production changes, owning package contracts, and existing component and Web user-path coverage; it does not restore the retired Plus mobile layout, Sidebar, Settings, Jobs, Schedule, or responsive-column changes.
