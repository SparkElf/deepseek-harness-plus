...
本data-only package patch official DSH revision `5dda764ed3aa172535a7967b06ff95d9cbfe536a`。它让existing deliverables projection识别会写入原始Office文件的`officecli` argv operations，使完成turn把DOCX、XLSX或PPTX path列为可点击产物。它不render、copy、convert或cache该文件。
