...
The target is the exact official source base `5dda764ed3aa172535a7967b06ff95d9cbfe536a`. The Plus apply command verifies the base ancestry and payload before applying it. This package has no JavaScript entry, Cordis lifecycle, install script, or capability implementation.
