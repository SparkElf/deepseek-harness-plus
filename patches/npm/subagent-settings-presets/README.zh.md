...
target是exact official source base `183f08e9c6dde7e36cd2318eaee70b0da08fb35e`。Plus apply command在应用前验证base ancestry与payload。本package没有JavaScript entry、Cordis lifecycle、install script或capability implementation。
