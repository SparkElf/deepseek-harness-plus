...
The target is exact official source base `cd5ef8148158c3a752a658978873241fdf8e2bbc`. The package has no JavaScript entry, lifecycle script, credential material, or fallback variant. Retire it when official DSH exposes an equivalent profile-selected browser-authentication policy.
