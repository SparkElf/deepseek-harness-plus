...
The ToolRuntime enforced Schema subset remains unchanged, and the MCP server continues to validate the complete original Schema. The target is exact official source revision `5dda764ed3aa172535a7967b06ff95d9cbfe536a`.
