...
针对official DSH source revision `b2e3b2a0125854567a4a5fcba75782e42fe84901`的data-only temporary patch。它增加`WorkspaceRegistry.withStorageRestore`，在external file replacement期间关闭Workspace durable domain，并在return前通过正常initialization重开。
