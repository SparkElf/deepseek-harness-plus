...
Data-only temporary patch for the official DSH source revision `b2e3b2a0125854567a4a5fcba75782e42fe84901`. It adds `WorkspaceRegistry.withStorageRestore`, which closes the Workspace durable domain around an external file replacement and reopens through normal initialization before returning.
