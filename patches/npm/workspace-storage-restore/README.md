...
Data-only temporary patch for the official DSH source revision `5dda764ed3aa172535a7967b06ff95d9cbfe536a`. It adds `WorkspaceRegistry.withStorageRestore`, which closes the Workspace durable domain around an external file replacement and reopens through normal initialization before returning.
