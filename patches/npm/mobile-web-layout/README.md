...
The target is the exact official source base `0a53fb55bea101816fa226bb964ae2bed71c343b`. Later official composer-control and model-menu mobile fixes are inherited and are not duplicated in this payload. The package has no JavaScript entry, lifecycle script, or fallback variant.
