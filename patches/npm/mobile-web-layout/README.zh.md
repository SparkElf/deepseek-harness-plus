...
target是exact official source base `0a53fb55bea101816fa226bb964ae2bed71c343b`。official后续composer-control与model-menu mobile fixes直接继承，不在payload中复制。本package没有JavaScript entry、lifecycle script或fallback variant。
