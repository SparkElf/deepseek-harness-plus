...
需要：`connection` · `webServer` · `settings` · `workspaceRegistry`
...
来源：[`packages/plus/backup/src/index.ts:17`](../packages/plus/backup/src/index.ts)

<a id="sparkelfdsh-plugin-dataops"></a>

## `@sparkelf/dsh-plugin-dataops`

需要：`connection` · `credentials` · `webServer` · `tools`
...
来源：[`packages/plus/dataops/src/index.ts:36`](../packages/plus/dataops/src/index.ts)
...
来源：[`packages/plus/mcp-credentials/src/index.ts:101`](../packages/plus/mcp-credentials/src/index.ts)
...
来源：[`packages/plus/subagent-settings/src/index.ts:30`](../packages/plus/subagent-settings/src/index.ts)
