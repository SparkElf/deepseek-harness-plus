...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.documentParser` | `seam` | `document-attachments` | - | - | - | The Plus capability package owns provider registration and selection, the MinerU implementation, authenticated intake, durable artifacts, and bounded model projection. |
