...
Source: [`packages/host/frontend-static/src/index.ts:19`](../packages/host/frontend-static/src/index.ts)
...
Requires: `credentials` · `webServer` · `tools`
...
Source: [`packages/mcp/dataops-integration/src/index.ts:35`](../packages/mcp/dataops-integration/src/index.ts)
...
- `@deepseek-ai/dsh-tool-chart` — requires `tools` ([`packages/chart/tool-chart/src/index.ts`](../packages/chart/tool-chart/src/index.ts))
