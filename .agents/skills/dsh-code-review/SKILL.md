...
- **Lifecycle and concurrency:** follow [user-owned edge cases](../architecture-planning/SKILL.md#user-owned-edge-cases). Apply [defensive-patterns.md](../../../docs/defensive-patterns.md) to the agreed user path and reported failures, not to invent hypothetical blockers.
