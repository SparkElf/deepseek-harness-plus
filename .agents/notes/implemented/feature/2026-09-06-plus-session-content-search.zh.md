...
这是[内容搜索opt-in决策](../../archived/architecture/2026-08-13-session-content-search-opt-in.md)预期的deployment opt-in，不是replacement provider或official-default change。Archive visibility仍为独立语义：归档Session在Workspace archive state恢复前不进入侧边栏结果。
