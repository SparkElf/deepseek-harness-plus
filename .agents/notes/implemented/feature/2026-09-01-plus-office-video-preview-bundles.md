...
The Plus profile includes `@huanlin/dsh-plugin-better-sidebar-plugin-office@0.2.0` and `dsh-video-preview@0.1.4` immediately after `dsh-better-sidebar@0.19.0`. The distribution installs all three as exact profile dependencies and records both preview packages as runtime bundles in the deployment lock.
