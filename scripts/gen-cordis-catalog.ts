...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  documentPrompt: 'client-side Document intake and prompt transport — packages/plus/document-attachments/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  DocumentParserProvider: 'document parser provider contract is owned by packages/plus/document-attachments/README.md',
  DocumentParseRequest: 'document parser request is owned by packages/plus/document-attachments/README.md',
  DocumentParseResult: 'document parser result is owned by packages/plus/document-attachments/README.md',
