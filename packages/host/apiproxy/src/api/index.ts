...
import type { BackupsApi } from './backups.ts'
...
export interface ApiProxy {
  ...
  /** Host-only backup transport faces (temp-file tokens); absent from IApiClient. */
  backups: BackupsApi
  /**
...
export type { BackupArtifact, BackupsApi } from './backups.ts'
