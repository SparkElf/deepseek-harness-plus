/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-settings-backup`.
 * @module @deepseek-ai/dsh-client-ui-settings-backup/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-settings-backup'
