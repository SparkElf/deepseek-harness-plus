...
export const zh = {
  ...
  'attachment.dropImageTitle': '拖动图片到此处即可添加',
  'attachment.dropBlocked': '当前无法添加附件',
  'attachment.pending': '待发送附件',
  'attachment.scrollLeft': '向左滚动附件',
  'attachment.scrollRight': '向右滚动附件',
  'attachment.add': '添加附件',
  'attachment.sendFailed': '附件发送失败（{reason}），文件仍在输入框中，可重试或移除',
  'document.remove': '移除文档 {name}',
  'document.label': '文档',
  'document.unsupportedType': '仅支持 PDF、DOCX、PPTX、XLSX 格式的文档',
  'document.nameRequired': '文档必须有文件名',
  'document.unavailable': '当前未配置文档解析，请联系管理员后重试',
  'document.parserUnavailable': '文档解析服务当前不可用，文件仍在输入框中',
  'document.parseFailed': '文档解析失败，文件仍在输入框中，可重试或移除',
  'document.parsedTooLarge': '文档解析内容超过直接阅读上限，请移除或改用更小的文档',
  'document.tooMany': '一条消息最多添加 {count} 个文档',
  'document.fileTooLarge': '单个文档不能超过 {size}',
  'document.totalTooLarge': '文档总大小超过 {size}，请移除部分文档',
  ...
  'command.documentsUnsupported': '/{command} 不接受文档附件，请先移除文档',
...
export const en = {
  ...
  'attachment.dropTitle': 'Drag images or documents here to add them',
  'attachment.dropImageTitle': 'Drag images here to add them',
  ...
  'attachment.sendFailed': 'Sending attachments failed ({reason}); retry or remove the files still in the composer',
  'document.remove': 'Remove document {name}',
  'document.label': 'Document',
  'document.unsupportedType': 'Only PDF, DOCX, PPTX, and XLSX documents are supported',
  'document.nameRequired': 'Documents must have a filename',
  'document.unavailable': 'Document parsing is not configured; contact your administrator and try again',
  'document.parserUnavailable': 'Document parsing is unavailable; your files remain in the composer',
  'document.parseFailed': 'Document parsing failed; retry or remove the files still in the composer',
  'document.parsedTooLarge': 'Parsed document content exceeds the direct-reading limit; remove it or use a smaller document',
  'document.tooMany': 'A message can include up to {count} documents',
  'document.fileTooLarge': 'Each document must be smaller than {size}',
  'document.totalTooLarge': 'Documents exceed {size} in total; remove some and try again',
  ...
  'command.documentsUnsupported': '/{command} does not accept document attachments; remove them first',
