...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attachment AttachmentPicker id \'attachment-picker\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:262',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:252',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-backup BackupSection id \'backup\'',
      'client-ui-settings-general GeneralSection id \'general\'',
      'client-ui-settings-models ModelsSection id \'models\'',
      'client-ui-settings-plugins SubagentSettingsSection id \'subagents\'',
      'client-ui-settings-plugins PluginsSettingsSection id \'plugins\'',
      'mcp-dataops DataOpsSection id \'dataops\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, render_chart, skill, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-tool), so it exists while that entry is mounted',
    occupants: [
      'client-ui-chart ChartRow key \'render_chart\'',
