...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.brand.badge',
    kind: 'single',
    scope: 'root',
    summary: 'Optional replacement for the blank-session brand-adjacent badge.',
    doc: 'Optional replacement for the blank-session brand-adjacent badge.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.brand.badge\', () => ctx.slots.register(\n      { name: \'conversation.hero.brand.badge\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional brand-name artwork replacing the blank-session headline text.',
    doc: 'Optional brand-name artwork replacing the blank-session headline text.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    occupants: [
      '@sparkelf/dsh-plugin-document-attachments DraftDocuments',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.message.images.documents',
    kind: 'single',
    scope: 'session',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Title-adjacent desktop actions; mobile layouts place them beside the View tabs.',
    doc: 'Title-adjacent desktop actions; mobile layouts place them beside the View tabs.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Immutable Session context kept beside the title on every layout.',
    doc: 'Immutable Session context kept beside the title on every layout.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'conversation.trajectory.images.documents',
    kind: 'single',
    scope: 'session',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@sparkelf/dsh-plugin-backup BackupSection id \'backup\'',
      '@sparkelf/dsh-plugin-dataops DataOpsSection id \'dataops\'',
      '@sparkelf/dsh-plugin-subagent-settings SubagentSettingsSection id \'subagents\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      '@sparkelf/dsh-plugin-dataops DataOpsExpiryModal id \'dataops-authorization\'',
    ],
    replaceRisk: 'none',
