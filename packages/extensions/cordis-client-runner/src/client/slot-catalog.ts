...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.trajectory.toolbar.utilities',
    kind: 'list',
    scope: 'session',
    summary: 'Compact Session utilities immediately before the Trajectory search field.',
    doc: 'Compact Session utilities immediately before the Trajectory search field.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-trajectory), so it exists while that entry is mounted',
    occupants: [
      'session-log-export SessionLogDownloadToolbarAction id \'session-log-download\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.trajectory.toolbar.utilities\', () => ctx.slots.register(\n      { name: \'conversation.trajectory.toolbar.utilities\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-trajectory/src/client/index.ts:42',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      '@sparkelf/dsh-client-ui-skill-center SkillCenterPage',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      '@sparkelf/dsh-client-ui-skill-center SkillCenterPanelIcon',
    ],
    replaceRisk: 'none',
