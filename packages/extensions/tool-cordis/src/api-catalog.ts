  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Claim the fallback seat: the handler answering every request no named route matches. One owner only; a second registration throws because two fallbacks cannot compose.',
      ...
      },
      {
        ...
        description: 'Register an index.html transform, applied by the fallback owner to every index response in registration order.',
        parameters: [{ name: 'transform', description: 'Pure HTML-to-HTML function.' }],
        returns: 'The disposer removing the transform.',
      },
      {
        signature: 'applyIndexTaps(html: string): string',
        description: 'Run an index.html body through the registered taps in registration order. The fallback owner calls this for every index response it renders.',
